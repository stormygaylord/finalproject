...
<body class="other">
    ...
    <main>
        <div class="container">
            <h2>Message Sent!</h2>
            <p>Thanks for your interest! I have received your message, and we will be in touch shortly.</p>
            <img src="images/happy.png" alt="Happy Face" title="Success!" width="500">
        </div>
    </main>
